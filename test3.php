  ...
  <body>
    <div class="content">
      <div class="container">
        ...
        <hr>
        <h2 class="mb-5" style="display: inline;">전공 입력</h2> <h6 style="display: inline;">&#40; 융합과목 포함 &#41;</h6>
        <br>
          ...
          <table class="table custom-table" id="table">
            ...
            <tbody>
              ...
              while($row = $result -> fetch_assoc()){
                ...
                <th scope='row'>
                  <label class='control control--checkbox'>
                  <input type='checkbox' name='전공' value = '[&quot;". $row["학수번호"]. "&quot;,&quot;". $row["교과목명"]. "&quot;,". $row["학점"]. "]' />
                  <div class='control__indicator'></div>
                  </label>
                </th>
                <td>". $row["학수번호"] ."</td>
