        ...
        <div class="table-responsive custom-table-responsive" style="height: 500px; overflow:auto">
          <table class="table custom-table" id="table">
              ...
              <tr>
                <th scope="col">
                  <label class="control control--checkbox">
                    <input type="checkbox" class="js-check-all" value="<?php echo $row['학수번호']; ?>" />
            ...
            <tbody>
              ...
              $sql="SELECT * FROM 2023교양 where 학수번호 REGEXP 'CES|FES' ";
              ...
              while($row = $result -> fetch_assoc()){
                ...
                <th scope='row'>
                  <label class='control control--checkbox'>
                    <input type='checkbox' name='기초교육' value = '[&quot;". $row["학수번호"]. "&quot;,&quot;". $row["교과목명"]. "&quot;,". $row["학점"]. "]' />
                    <div class='control__indicator'></div>
                  </label>
                </th>
                <td>". $row["학수번호"] ."</td>
